...
def test_get_paths_and_scores():
    ...
    expect = [
        {'score': 1600, 'lineage': 'lineage1.1.1', 'scores': {'lineage1': 500, 'lineage1.1': 1000, 'lineage1.1.1': 100}},
...
def test_call_lineage():
    ...
    lineage_calls = {
        "lineage1": {
            "var1": var1_call, "var1a": var1a_call,
        },
        "lineage1.1": {
            "var1.1": var1_1_call,
        },
    ...
    expect = {
        ...
        "calls": {
            "lineage1.1.1": copy.deepcopy(lineage_calls)
        }
    }
