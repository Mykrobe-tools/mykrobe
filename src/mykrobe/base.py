...
sequence_or_graph_parser_mixin.add_argument("sample", type=str, help="sample id")
...
sequence_or_graph_parser_mixin.add_argument(
    "--tmp", help="tmp directory (default: tmp/)", default="tmp/"
)
sequence_or_graph_parser_mixin.add_argument(
    "--keep_tmp", help="Dont remove tmp files", action="store_true"
)
sequence_or_graph_parser_mixin.add_argument(
    "--skeleton_dir",
...
sequence_or_graph_parser_mixin.add_argument(
    "-m", "--memory", type=str, help="memory for graph constuction", default="1GB"
)
sequence_or_graph_parser_mixin.add_argument(
...
sequence_parser_mixin.add_argument(
    "seq", type=str, help=SEQUENCE_FILES_HELP_STRING, nargs="+"
)
...
sequence_or_binary_parser_mixin.add_argument(
    "-1", "--seq", metavar="seq", type=str, nargs="+", help=SEQUENCE_FILES_HELP_STRING
)
sequence_or_binary_parser_mixin.add_argument(
...
force_mixin.add_argument("-f", "--force", action="store_true", help="force")
...
genotyping_mixin.add_argument(
    "--report_all_calls", help="report all calls", action="store_true", default=False
)
genotyping_mixin.add_argument(
    "--expected_error_rate",
